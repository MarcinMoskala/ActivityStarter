...
public class DataActivityRotationTest {

    @Rule
    public ActivityTestRule<MainActivity> activityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void defaultDataActivityTest() throws InterruptedException, RemoteException {
    ...
    @Test
    public void dataActivityTest() throws InterruptedException, RemoteException {
